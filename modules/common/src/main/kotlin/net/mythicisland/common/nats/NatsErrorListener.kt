...
class NatsErrorListener : ErrorListener {
    ...
    override fun heartbeatAlarm(conn: Connection?, sub: JetStreamSubscription?, lastStreamSequence: Long, lastConsumerSequence: Long) {
    ...
    override fun flowControlProcessed(conn: Connection?, sub: JetStreamSubscription?, id: String?, source: FlowControlSource?) {
